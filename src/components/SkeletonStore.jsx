...
//   return (
//     <svg width={SIZE} height={SIZE} viewBox={`0 0 ${SIZE} ${SIZE}`} className="bg-slate-100 rounded">
//       {/* Draw connections */}
//       {connections.map((c, i) => {
...
//   useEffect(() => {
//     document.title = "PixelPoint • Skeleton Store";
//     fetchSkeletons();
//   }, []);
...
//     } catch (err) {
//       console.error("Error fetching skeletons:", err);
//       setSkeletons([]);
//     } finally {
//       setLoading(false);
//     }
...
//   const downloadSkeleton = (skeleton) => {
...
//   return (
//     <div className={`min-h-screen w-full transition-colors duration-300 ${theme.bg} ${theme.text}`}>
//       <SEO
//         title="PixelPoint • Skeleton Store"
//         description="Browse and download skeleton templates for keypoint annotation."
//         keywords="skeleton, templates, keypoint, annotation"
//       />

//       {/* Header */}
//       <header className={`border-b ${theme.sidebar}`}>
...
//             </Link>
//             <h1 className="text-3xl font-bold">Skeleton Store</h1>
//           </div>
//           <button
...
//             <span className="ml-3">Loading skeletons...</span>
//           </div>
//         ) : skeletons.length === 0 ? (
//           <div className={`text-center py-20 rounded-lg border-2 border-dashed ${theme.card}`}>
//             <p className="text-lg font-medium">No skeletons available yet</p>
//             <p className={`${theme.subText} mt-2`}>
//               Create and export skeletons from the{" "}
//               <Link to="/skeletons" className="text-indigo-500 hover:underline font-semibold">
//                 Skeleton Editor
//               </Link>{" "}
...
//               <div
//                 key={skeleton.id}
//                 className={`rounded-xl border overflow-hidden shadow-lg hover:shadow-xl transition-all ${theme.card}`}
//               >
//                 {/* Thumbnail */}
//                 <div className="p-4 bg-gradient-to-br from-indigo-50 to-blue-50 dark:from-slate-700 dark:to-slate-800 flex items-center justify-center">
//                   <SkeletonThumbnail 
...
//                   {/* Name */}
//                   <div>
//                     <h2 className="text-xl font-bold line-clamp-1">{skeleton.name}</h2>
//                   </div>

//                   {/* Author & Date */}
//                   <div className="flex items-center justify-between text-sm">
//                     <span className={`font-medium ${theme.subText}`}>
//                       By {skeleton.author || "Unknown"}
//                     </span>
//                     <span className={`text-xs ${theme.subText}`}>
//                       {skeleton.exportedAt
//                         ? new Date(skeleton.exportedAt).toLocaleDateString()
//                         : "N/A"}
//                     </span>
//                   </div>
...
//                   {/* Stats */}
//                   <div className="flex gap-4 text-xs pt-2 border-t border-inherit">
//                     <span className={theme.subText}>
//                       📍 {skeleton.keypoints?.length || 0} nodes
//                     </span>
//                     <span className={theme.subText}>
//                       🔗 {skeleton.connections?.length || 0} connections
//                     </span>
//                   </div>
...
//                     className="w-full mt-4 flex items-center justify-center gap-2 py-2.5 px-4 rounded-lg font-medium bg-indigo-600 hover:bg-indigo-700 text-white transition-all shadow-lg hover:shadow-xl"
//                   >
//                     <Download size={16} />
//                     Download
//                   </button>
...
//       {/* Footer Info */}
//       <footer className={`border-t ${theme.sidebar} py-8 mt-12`}>
//         <div className="max-w-7xl mx-auto px-6 text-center">
//           <p className={theme.subText}>
//             Downloaded skeletons can be imported in the{" "}
//             <Link to="/skeletons" className="text-indigo-500 hover:underline font-semibold">
//               Skeleton Editor
//             </Link>
//           </p>
...
export default function SkeletonStore() {
  ...
  return (
    <div className={`min-h-screen transition-colors duration-500 font-sans ${theme.bg} ${theme.text}`}>
      <SEO title="PixelPoint • Skeleton Store" />
